package ru.kpfu.itis.android.asadullin.mywallet.data.db.entity
...
data class TransactionEntity(
    ...
    companion object {
        fun fromTransactionModel(transactionModel: TransactionCatalog.TransactionModel) = TransactionEntity(
